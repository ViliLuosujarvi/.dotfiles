...
#base00 = rgb:1e0528   (background - very dark purple)
#base01 = rgb:1a092d   (darker background variant)
#base02 = rgb:331354   (selection/bg layers)
#base03 = rgb:320f55   (comments / subtle text)

#base04 = rgb:917EBF   (muted foreground)
#base05 = rgb:ffeeff   (main text - near white)
#base06 = rgb:ffeeff   (lighter text)
#base07 = rgb:f8c0ff   (highlighted text)

#base08 = rgb:00d9e9   (cyan accent)
#base09 = rgb:aa00a3   (magenta accent)
#base0A = rgb:955ae7   (purple accent)
#base0B = rgb:05cb0d   (green)
#base0C = rgb:b900b1   (deep magenta)
#base0D = rgb:550068   (dark purple)
#base0E = rgb:8991bb   (desaturated blue)
#base0F = rgb:4d6fff   (blue accent)

## Adittional ##
# baseAD01 = rgb:3d85c6  (bright blue) 
...
declare-option str base04 'rgb:917EBF'   #873582
