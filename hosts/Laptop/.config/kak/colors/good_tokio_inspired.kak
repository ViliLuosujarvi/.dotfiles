...
declare-option str yellow "FFF04A"
...
set-face global link "rgb:%opt{cyan}+b"
set-face global bullet "rgb:%opt{yellow}+b"
set-face global list "rgb:%opt{green}"

set-face global Default "rgb:%opt{fg},default"

set-face global PrimarySelection "rgb:000000,rgb:%opt{yellow}"
set-face global SecondarySelection "rgb:%opt{fg},rgba:%opt{yellow}%opt{selectionalpha}"

set-face global PrimaryCursor "rgb:000000,rgb:%opt{yellow}"
set-face global SecondaryCursor "rgb:000000,rgb:%opt{yellow}"
set-face global PrimaryCursorEol "rgb:000000,rgb:%opt{yellow}"
set-face global SecondaryCursorEol "rgb:000000,rgb:%opt{yellow}"
...
set-face global MenuInfo "rgb:%opt{cyan}"
...
set-face global StatusLineInfo "rgb:%opt{cyan}"
...
set-face global InlayDiagnosticInfo "rgb:%opt{cyan}"
...
set-face global LineFlagInfo "rgb:%opt{cyan}"
...
set-face global DiagnosticInfo ",,rgb:%opt{cyan}+c"
...
try %{ set-option global rainbow_colors "rgb:%opt{magenta}" "rgb:%opt{cyan}" "rgb:%opt{blue}" }
